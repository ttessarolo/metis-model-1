# Metis 0.43 grammar and standard-library reference — T30 v3

This is the generic retrieval context for the fresh T30-v3 evaluation. It is
...
Compact attributes syntax is valid for exactly one assignment; two or more assignments require a braced attributes group.

Canonical two-member form:

```metis
attributes { first = value.one second = value.two }
```
