...
# A bounded dialogue can have 32 question rounds plus operator refinements.
# More short answers do not increase the existing total memory allowance.
MAX_HISTORY_MESSAGES = 64
MAX_HISTORY_BYTES = 20 * MAX_HISTORY_MESSAGE_BYTES
